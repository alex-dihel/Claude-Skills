...
| Skill | Description |
|---|---|
| [brevity-filter](./brevity-filter/) | A reusable reference file (not a Claude Skill) for Claude.ai projects, cutting filler and padding from Claude's replies without sacrificing accuracy or technical detail. |
